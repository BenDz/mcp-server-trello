...
try {
  ...
  if (!parsed.name || !parsed.name.startsWith('io.github.BenDz/')) {
    console.error('❌ Invalid name format. Must start with io.github.BenDz/');
    process.exit(1);
  }
  ...
  if (npmPackage.identifier !== '@BenDz/mcp-server-trello') {
